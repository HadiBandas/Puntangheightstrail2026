...
export const LogoIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        {/* Runner Body - Forest Green */}
        <path d="M120 40 L100 70 L80 50 L70 65 L95 95 L120 60 Z" fill="#166534" stroke="#166534" strokeWidth="5" strokeLinejoin="round"/>
        <path d="M95 95 L95 120 L125 120 L125 105" fill="none" stroke="#166534" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M70 65 L50 85 L65 100" fill="none" stroke="#166534" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        
        {/* Runner Head - Trail Orange */}
        <circle cx="130" cy="35" r="12" fill="#f97316"/>
        
        {/* Mountain Outline/Abstract - Dark Jungle Green */}
        <path d="M20 130 L60 70 L100 110 L140 50 L180 130 H20Z" fill="none" stroke="#022c22" strokeWidth="3" opacity="0.2"/>
    </svg>
);
...
export const Mouse: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="5" y="2" width="14" height="20" rx="7"/><path d="M12 6v4"/></svg>
);
...
export const Footprints: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 16v-2.38C4 11.5 2.97 10.5 3 8c.03-2.72 1.49-6 4.5-6C9.37 2 11 3.8 11 8c0 1.25-.76 2-1.5 3.29C10.35 12.59 11 13.5 11 16"/><path d="M14 16v-2.38c0-2.12-1.03-3.12-1-5.62.03-2.72 1.49-6 4.5-6C19.37 2 21 3.8 21 8c0 1.25-.76 2-1.5 3.29C20.35 12.59 21 13.5 21 16"/><path d="M9 22v-3"/><path d="M19 22v-3"/></svg>
);
...
export const Cloud: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19c0-3.037-2.463-5.5-5.5-5.5S6.5 15.963 6.5 19"/><path d="M6.5 19C4.015 19 2 16.985 2 14.5c0-2.206 1.6-4.03 3.71-4.425.33-3.98 3.66-7.075 7.79-7.075 4.136 0 7.53 3.152 7.767 7.175C22.913 11.05 24.5 12.663 24.5 14.5c0 2.485-2.015 4.5-4.5 4.5"/></svg>
);
